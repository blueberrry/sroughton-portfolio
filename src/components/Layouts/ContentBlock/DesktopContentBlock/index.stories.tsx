...
const meta: Meta<typeof DesktopContentBlock> = {
  ...
  argTypes: {
    reversed: {
      ...
      defaultValue: false,
      name: 'Reverse row',
      description: 'Text LHS (left hand side) and Images RHS (default) images LHS and text RHS (reversed)',
    },
  },
  decorators: [
    (Story) => {
...
export const Standard: Story = {
  args: {
    ...
    images: [
      {
        id: 'b',
        src: 'https://i.pinimg.com/564x/26/d0/c7/26d0c7f36b920c83a15e727b82a1dab7.jpg',
        alt: '',
...
export const ImagePerParagraph: Story = {
  args: {
    paragraphs: [
      {
        id: 'a',
